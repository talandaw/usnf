    ...
    <div id="content" class="content full">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <h2>Tooltips</h2>
            <p>Tight pants next level keffiyeh <a href="#" data-toggle="tooltip" data-original-title="Default tooltip" > you probably</a> haven't heard of them.
              Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable
              quinoa 8-bit american apparel
              <a href="#" id="back-top" data-placement="left"  data-toggle="tooltip" title="" data-original-title="Another tooltip"> have a</a> terry richardson vinyl chambray. </p>
          </div>
          <div class="col-md-6">
            <h2>Modal Box</h2>
